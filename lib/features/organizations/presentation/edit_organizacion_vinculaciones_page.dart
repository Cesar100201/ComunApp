...
class EditOrganizacionVinculacionesPage extends StatefulWidget {
  final Organizacion organizacion;

  const EditOrganizacionVinculacionesPage({
    super.key,
...
class _EditOrganizacionVinculacionesPageState extends State<EditOrganizacionVinculacionesPage> {
  ...
  Future<void> _cargarVinculaciones() async {
    ...
    for (var v in todasVinculaciones) {
      ...
      if (v.organizacion.value?.id == widget.organizacion.id) {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            if (widget.organizacion.cargos.isEmpty)
              Container(
                padding: const EdgeInsets.all(20),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      DropdownButtonFormField<String>(
                        ...
                        items: widget.organizacion.cargos.map((cargo) {
                      ...
                      DropdownButtonFormField<Ambito>(
                        ...
                        onChanged: (value) {
                          if (value != null) {
                            setState(() => _ambitoSeleccionado = value);
                          }
                        },
                      ),
                      const SizedBox(height: 12),
