...
import '../data/services/bulk_upload_consejos_service.dart';

class BulkUploadConsejosPage extends StatefulWidget {
  const BulkUploadConsejosPage({super.key});

  @override
  State<BulkUploadConsejosPage> createState() => _BulkUploadConsejosPageState();
}

class _BulkUploadConsejosPageState extends State<BulkUploadConsejosPage> {
  File? _selectedFile;
  ...
  Future<void> _descargarPlantillaExcel() async {
    try {
      ...
      final path = '${directory.path}/plantilla_carga_masiva_consejos.xlsx';
      ...
      if (bytes != null) {
        ...
        if (mounted) {
          ...
          final result = await FilePicker.platform.saveFile(
            ...
            fileName: 'plantilla_carga_masiva_consejos.xlsx',
            bytes: uint8List,
