...
class EditConsejoOrganizacionPage extends StatefulWidget {
  ...
  const EditConsejoOrganizacionPage({
    super.key,
    required this.consejo,
  });

  @override
  State<EditConsejoOrganizacionPage> createState() => _EditConsejoOrganizacionPageState();
}

class _EditConsejoOrganizacionPageState extends State<EditConsejoOrganizacionPage> {
