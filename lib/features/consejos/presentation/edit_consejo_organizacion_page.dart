...
class EditConsejoOrganizacionPage extends StatefulWidget {
  final ConsejoComunal consejo;

  const EditConsejoOrganizacionPage({super.key, required this.consejo});

  @override
  State<EditConsejoOrganizacionPage> createState() =>
      _EditConsejoOrganizacionPageState();
}

class _EditConsejoOrganizacionPageState
    extends State<EditConsejoOrganizacionPage> {
  ...
  void _initializeData() {
    ...
    _cargos = List<Cargo>.from(widget.consejo.cargos);
  }
  ...
  Future<void> _guardar() async {
    ...
    try {
      ...
      await isar.writeTxn(() async {
        ...
        if (consejo != null) {
          consejo.cargos = _cargos.map((cargo) {
            return Cargo()
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "Define los cargos de la estructura organizativa del consejo comunal.",
                  ...
                  Expanded(
                    child: TextFormField(
                      ...
                      decoration: const InputDecoration(
                        ...
                        hintText: "Ej: Vocero, Coordinador, etc.",
                      ),
                    ),
                  ),
