...
class EditConsejoVinculacionesPage extends StatefulWidget {
  ...
  const EditConsejoVinculacionesPage({super.key, required this.consejo});

  @override
  State<EditConsejoVinculacionesPage> createState() =>
      _EditConsejoVinculacionesPageState();
}

class _EditConsejoVinculacionesPageState
    extends State<EditConsejoVinculacionesPage> {
  ...
  final Ambito _ambitoSeleccionado =
      Ambito.Comunal; // Fijo para consejos comunales
